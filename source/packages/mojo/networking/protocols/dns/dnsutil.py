...
from mojo.networking.protocols.dns.dnsconst import HAS_A_TO_Z
from mojo.networking.protocols.dns.dnsconst import HAS_ONLY_A_TO_Z_NUM_HYPHEN
from mojo.networking.protocols.dns.dnsconst import HAS_ASCII_CONTROL_CHARS
from mojo.networking.protocols.dns.dnsconst import HAS_ONLY_A_TO_Z_NUM_HYPHEN_UNDERSCORE

from mojo.networking.protocols.dns.exceptions import DnsBadTypeInNameError

from mojo.networking.protocols.dns.dnsvalidation import validate_service_name
